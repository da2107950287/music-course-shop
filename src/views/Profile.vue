<template>
  <div class="profile">
    ...
    <el-dialog :visible.sync="dialogVisible2" width="480px" :before-close="handleClose2" center>
      <el-form :model="loginForm" :rules="rules" ref="loginForm" class="demo-loginForm form">
        <div class="popup-title bind-phone">绑定、更换手机号</div>
        <el-form-item prop="phone">
          <el-input v-model.number="loginForm.phone" maxlength="11" placeholder="请输入新的手机号"></el-input>
        </el-form-item>

        <el-form-item prop="graphicsCode" class="pass graphics-code-box">
          <el-input
            v-model="loginForm.graphicsCode"
            placeholder="请输入图形验证码"
            class="graphics-code-input"
          ></el-input>
        ...
        <el-form-item prop="smsCode" class="pass">
          <el-input v-model="loginForm.smsCode" placeholder="请输入短信验证码"></el-input>
